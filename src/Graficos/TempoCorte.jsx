...
const TempoCorte = () => {
  ...
  useEffect(() => {
    if (sensorData.length > 0) { 
      ...
      const tempCtx = document.getElementById('GraphSensorTof1');
          ...
          datasets: [
            {
              ...
              backgroundColor: ['rgba(18,55,104,255)', 'rgb(0,0,0,0)'],
  ...
  return (
    <div className='Body'>
      <div className='BodyLegendas'>
        <p className='TextLegendas'>Tempo de corte</p>
        <p className='TextLegendasNum'> { sensorTofDist.toFixed(3) } M </p>
        <p className='TextLegendaSensorTof'>Tempo em minutos</p>
      </div>
      <div className='BodyGrafico'>
        <canvas id="GraphSensorTof1" width="50" height="50"></canvas>
      </div>
    </div>
  );
};

export default TempoCorte;
